...
#написать размер словаря - размерность пространства заисывать поз и нег в два стлб
#выкинуть лишние слова, которые нихуя не весят? ну или нет чтоб точность была выше типа
